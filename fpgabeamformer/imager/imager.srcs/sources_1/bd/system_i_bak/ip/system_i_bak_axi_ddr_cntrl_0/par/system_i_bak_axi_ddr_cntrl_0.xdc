...
set_multicycle_path -setup 8 -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_top/calDone*/C}]
set_multicycle_path -end -hold 7 -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_top/calDone*/C}]
...
set_max_delay 5.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_addr_decode/io_ready_lvl_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_io_ready_lvl_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 5.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_addr_decode/io_read_data_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_io_read_data_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/phy_ready_riuclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_phy_ready_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/bisc_complete_riuclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_bisc_complete_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_riu/io_addr_strobe_lvl_riuclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_io_addr_strobe_lvl_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_riu/io_write_strobe_riuclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_io_write_strobe_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_riu/io_address_riuclk_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_io_addr_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_riu/io_write_data_riuclk_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_io_write_data_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */en_vtc_in_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_en_vtc_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_ddr_cal_riu/riu2clb_valid_r1_riuclk_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_riu2clb_valid_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/phy2clb_fixdly_rdy_low_riuclk_int_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_fixdly_rdy_low/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/phy2clb_fixdly_rdy_upp_riuclk_int_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_fixdly_rdy_upp/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/phy2clb_phy_rdy_low_riuclk_int_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_phy_rdy_low/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/phy2clb_phy_rdy_upp_riuclk_int_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_phy2clb_phy_rdy_upp/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 10.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */rst_r1_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_fab_rst_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */inst/clb2phy_t_b_addr_riuclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */inst/clb2phy_t_b_addr_i_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_en_lvl_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_en_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_we_r_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_we_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_addr_r_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_addr_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_di_r_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_di_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 3.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_rdy_cptd_sclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_rdy_cptd_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 12.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_rdy_lvl_fclk_reg/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_rdy_sync/SYNC[*].sync_reg_reg[0]/D}]
set_max_delay 12.0 -datapath_only -from [get_pins -hier -filter {NAME =~ */u_xsdb_arbiter/slave_do_fclk_reg[*]/C}] -to [get_pins -hier -filter {NAME =~ */u_slave_do_sync/SYNC[*].sync_reg_reg[0]/D}]
set_false_path -through [get_pins -hier -filter {NAME =~ */u_ddr4_infrastructure/sys_rst}]
set_false_path -from [get_pins -hier -filter {NAME =~ *input_rst_design_reg/C}] -to [get_pins -hier -filter {NAME =~ *rst_div_sync_r_reg[0]/D}] 
set_false_path -from [get_pins -hier -filter {NAME =~ *input_rst_design_reg/C}] -to [get_pins -hier -filter {NAME =~ *rst_riu_sync_r_reg[0]/D}] 
set_false_path -from [get_pins -hier -filter {NAME =~ *input_rst_design_reg/C}] -to [get_pins -hier -filter {NAME =~ *rst_mb_sync_r_reg[0]/D}]  
set_false_path -from [get_pins -hier -filter {NAME =~ *rst_async_riu_div_reg/C}] -to [get_pins -hier -filter {NAME =~ *rst_div_sync_r_reg[0]/D}] 
set_false_path -from [get_pins -hier -filter {NAME =~ *rst_async_mb_reg/C}]      -to [get_pins -hier -filter {NAME =~ *rst_mb_sync_r_reg[0]/D}] 
set_false_path -from [get_pins -hier -filter {NAME =~ *rst_async_riu_div_reg/C}] -to [get_pins -hier -filter {NAME =~ *rst_riu_sync_r_reg[0]/D}] 
## These below commands are used to create Interface ports for controller.

create_interface -quiet interface_system_i_bak_axi_ddr_cntrl_0
set_property interface interface_system_i_bak_axi_ddr_cntrl_0 [get_ports [list {c0_ddr4_dq[47]} {c0_ddr4_dq[46]} {c0_ddr4_dm_dbi_n[5]} {c0_ddr4_adr[4]} {c0_ddr4_adr[0]} {c0_ddr4_dqs_c[5]} {c0_ddr4_dqs_t[5]} {c0_ddr4_dq[44]} {c0_ddr4_dq[42]} {c0_ddr4_adr[5]} {c0_ddr4_adr[1]} {c0_ddr4_adr[6]} {c0_ddr4_adr[7]} {c0_ddr4_adr[10]} {c0_ddr4_adr[11]} {c0_ddr4_dq[41]} {c0_ddr4_dq[40]} {c0_ddr4_dq[45]} {c0_ddr4_dq[43]} {c0_ddr4_adr[2]} {c0_ddr4_adr[8]} {c0_ddr4_adr[12]} {c0_ddr4_adr[13]} {c0_ddr4_cs_n[0]} {c0_ddr4_dq[39]} {c0_ddr4_dq[38]} {c0_ddr4_dq[35]} {c0_ddr4_dq[34]} {c0_ddr4_dq[36]} {c0_ddr4_adr[3]} {c0_ddr4_ck_t[0]} {c0_ddr4_adr[9]} {c0_ddr4_adr[14]} {c0_ddr4_adr[15]} {c0_ddr4_dq[32]} {c0_ddr4_dm_dbi_n[4]} {c0_ddr4_dq[37]} {c0_ddr4_ck_c[0]} {c0_ddr4_ba[1]} {c0_ddr4_bg[0]} {c0_ddr4_adr[16]} {c0_ddr4_dm_dbi_n[6]} {c0_ddr4_dq[52]} {c0_ddr4_dq[53]} {c0_ddr4_dqs_c[4]} {c0_ddr4_dqs_t[4]} {c0_ddr4_dq[33]} {c0_ddr4_dq[28]} {c0_ddr4_dqs_t[0]} {c0_ddr4_dm_dbi_n[0]} c0_sys_clk_p c0_sys_clk_n {c0_ddr4_ba[0]} {c0_ddr4_dq[54]} {c0_ddr4_dq[26]} {c0_ddr4_dq[31]} {c0_ddr4_dq[30]} {c0_ddr4_dq[29]} {c0_ddr4_dqs_c[0]} {c0_ddr4_cke[0]} {c0_ddr4_dq[0]} {c0_ddr4_dq[1]} {c0_ddr4_odt[0]} {c0_ddr4_dq[50]} {c0_ddr4_dq[51]} {c0_ddr4_dq[55]} {c0_ddr4_dm_dbi_n[3]} {c0_ddr4_dq[27]} {c0_ddr4_dqs_c[3]} {c0_ddr4_dqs_t[3]} {c0_ddr4_dq[24]} {c0_ddr4_dq[2]} {c0_ddr4_dq[4]} {c0_ddr4_dq[5]} {c0_ddr4_dq[6]} {c0_ddr4_dq[7]} {c0_ddr4_dqs_t[6]} {c0_ddr4_dqs_c[6]} {c0_ddr4_dq[60]} {c0_ddr4_dq[62]} {c0_ddr4_dq[21]} {c0_ddr4_dq[20]} {c0_ddr4_dq[18]} {c0_ddr4_dq[25]} {c0_ddr4_dq[3]} {c0_ddr4_dm_dbi_n[1]} {c0_ddr4_dq[8]} {c0_ddr4_dq[10]} c0_ddr4_reset_n {c0_ddr4_dq[48]} {c0_ddr4_dq[49]} {c0_ddr4_dq[61]} {c0_ddr4_dq[63]} {c0_ddr4_dm_dbi_n[2]} {c0_ddr4_dq[19]} {c0_ddr4_dqs_c[2]} {c0_ddr4_dqs_t[2]} {c0_ddr4_dq[16]} c0_ddr4_act_n {c0_ddr4_dq[9]} {c0_ddr4_dq[14]} {c0_ddr4_dq[11]} {c0_ddr4_dm_dbi_n[7]} {c0_ddr4_dq[58]} {c0_ddr4_dq[59]} {c0_ddr4_dqs_t[7]} {c0_ddr4_dq[23]} {c0_ddr4_dq[22]} {c0_ddr4_dq[17]} {c0_ddr4_dqs_t[1]} {c0_ddr4_dqs_c[1]} {c0_ddr4_dq[15]} {c0_ddr4_dq[12]} {c0_ddr4_dq[13]} {c0_ddr4_dq[56]} {c0_ddr4_dq[57]} {c0_ddr4_dqs_c[7]}]]
